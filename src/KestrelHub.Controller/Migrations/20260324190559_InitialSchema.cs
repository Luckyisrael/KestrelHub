        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedDomain = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "54d487b4-ad36-4271-8549-4ae3ae22e7ca", "Admin", "ADMIN" },
                    { "2", "d9a46c32-2faf-4528-a1c0-c6679bebabd7", "Developer", "DEVELOPER" },
                    { "3", "474d3447-fa6f-4e37-a681-c831c20b50a1", "Viewer", "VIEWER" }
                });

            migrationBuilder.InsertData(
                table: "SystemSettings",
                columns: new[] { "Id", "InstalledAt", "InstanceId", "IsSetupComplete" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000002"), false });
